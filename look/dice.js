...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-107d19b7');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-107d19b7');}
...
function clearFlash(){dieView.classList.remove('rl-win-107d19b7');dieView.classList.remove('rl-lose-107d19b7');if(frameEl){frameEl.classList.remove('rl-win-107d19b7');frameEl.classList.remove('rl-lose-107d19b7');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-107d19b7');if(frameEl){frameEl.classList.add('rl-win-107d19b7');}}else{dieView.classList.add('rl-lose-107d19b7');if(frameEl){frameEl.classList.add('rl-lose-107d19b7');}}
...
var brandEl=document.querySelector('.rl-brand-107d19b7');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
